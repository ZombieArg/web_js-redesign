...
import { ArrowRight, ChevronRight, ExternalLink, Heart, Coffee, Palmtree, Church, Building2, Bot, Database, Code, GraduationCap, Instagram, Linkedin, MessageCircle, Building } from 'lucide-react';
...
function HomePage() {
  ...
  const whatsappLink = "https://wa.me/5491123966197?text=Hola%20DataVoices%2C%20me%20gustar%C3%ADa%20saber%20m%C3%A1s%20sobre%20sus%20servicios";
  ...
  const clients = [
    {
      ...
      icon: <Heart className="w-8 h-8 mb-3 text-[#FF5722]" />
    },
    {
      name: "Buda bar",
      url: "https://www.instagram.com/budabarbs/",
      icon: <Coffee className="w-8 h-8 mb-3 text-[#FF5722]" />
    },
    {
      name: "India bar",
      url: "https://www.instagram.com/indiabarbs",
      icon: <Palmtree className="w-8 h-8 mb-3 text-[#FF5722]" />
    },
    {
      name: "Misión Padre Pepe",
      url: "https://www.instagram.com/misionpadrepepebarracas",
      icon: <Church className="w-8 h-8 mb-3 text-[#FF5722]" />
    },
    {
      name: "Farmacias del Pueblo",
      url: "https://www.farmaciasdelpueblo.com.ar/",
      icon: <Building2 className="w-8 h-8 mb-3 text-[#FF5722]" />
    },
    {
      name: "BID",
      url: "https://www.iadb.org/es",
      icon: <Building className="w-8 h-8 mb-3 text-[#FF5722]" />
    }
  ];
      ...
      <header className="bg-white shadow-sm fixed w-full z-50">
        <nav className="container mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-8">
            <a href="#services" className="text-[#2B3674] hover:text-[#FF5722] transition-colors transform hover:scale-105 duration-200">
              {t('nav.services')}
            </a>
            <a href="#about" className="text-[#2B3674] hover:text-[#FF5722] transition-colors transform hover:scale-105 duration-200">
              {t('nav.about')}
            </a>
            <a href="#clients" className="text-[#2B3674] hover:text-[#FF5722] transition-colors transform hover:scale-105 duration-200">
              {t('nav.experience')}
            </a>
            <a href="#press" className="text-[#2B3674] hover:text-[#FF5722] transition-colors transform hover:scale-105 duration-200">
              {t('nav.press')}
            </a>
            <a href="#contact" className="text-[#2B3674] hover:text-[#FF5722] transition-colors transform hover:scale-105 duration-200">
              {t('nav.contact')}
            </a>
            <LanguageSelector />
          </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {services.map((service, index) => (
              ...
              >
                <div className="mb-4 transform group-hover:scale-110 transition-transform duration-200">{service.icon}</div>
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center text-[#FF5722] group-hover:text-[#F4511E]">
                    <span className="mr-2">{t('press.readMore')}</span>
    ...
    <div className="grid md:grid-cols-2 gap-12 max-w-4xl">
      <div className="flex flex-col items-center md:items-start">
        <div className="flex items-center space-x-3 mb-6">
          ...
          <span className="text-2xl font-bold">Data Voices</span>
        </div>
      ...
      <div className="flex flex-col items-center">
        ...
        <div className="grid grid-cols-1 gap-4 ">
          ...
          >
            ...
            <span className="text-lg">{t('footer.social.whatsapp')}</span>
          ...
          >
            ...
            <span className="text-lg">{t('footer.social.linkedin')}</span>
            <ExternalLink className="w-4 h-4 transform group-hover:translate-x-1 transition-transform" />
          </a>
          <a 
          ...
          >
            ...
            <span className="text-lg">{t('footer.social.instagram')}</span>
            <ExternalLink className="w-4 h-4 transform group-hover:translate-x-1 transition-transform" />
          </a>
        </div>
      </div>
  ...
  <div className="border-t border-white/10 mt-3 pt-8 text-center">
    <p className="text-white/60">&copy; 2024 DataVoices. {t('footer.rights')}.<br></br> hola@datavoices.com.ar</p>
  </div>
</footer>
