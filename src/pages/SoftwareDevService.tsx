...
export function SoftwareDevService() {
  ...
  const features = [
    {
      icon: <Cpu className="w-8 h-8 text-[#FF5722]" />,
      title: t('services.softwareDev.features.aiFirst.title'),
      description: t('services.softwareDev.features.aiFirst.description')
    },
    {
      icon: <Code className="w-8 h-8 text-[#FF5722]" />,
      title: t('services.softwareDev.features.custom.title'),
      description: t('services.softwareDev.features.custom.description')
    },
    {
      icon: <GitBranch className="w-8 h-8 text-[#FF5722]" />,
      title: t('services.softwareDev.features.agile.title'),
      description: t('services.softwareDev.features.agile.description')
    },
    {
      icon: <Layers className="w-8 h-8 text-[#FF5722]" />,
      title: t('services.softwareDev.features.scalable.title'),
      description: t('services.softwareDev.features.scalable.description')
    },
    {
      icon: <Settings className="w-8 h-8 text-[#FF5722]" />,
      title: t('services.softwareDev.features.fullCycle.title'),
      description: t('services.softwareDev.features.fullCycle.description')
    },
    {
      icon: <Users className="w-8 h-8 text-[#FF5722]" />,
      title: t('services.softwareDev.features.collaborative.title'),
      description: t('services.softwareDev.features.collaborative.description')
    }
  ];
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            <div className="lg:w-1/2">
              <h1 className="text-4xl md:text-5xl font-bold text-[#2B3674] mb-6">
                {t('services.softwareDev.hero.title')}
              </h1>
              <p className="text-xl text-[#2B3674]/80 mb-8">
                {t('services.softwareDev.hero.subtitle')}
              </p>
              <a 
                href="#contact"
              ...
              >
                <span className="mr-2">{t('services.softwareDev.hero.cta')}</span>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center text-[#2B3674] mb-16">
            {t('services.softwareDev.features.title')}
          </h2>
